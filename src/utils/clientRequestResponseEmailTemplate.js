export const clientRequestResponseEmailTemplate = (name, title, email, img, phone, description, status) => {
    return `
 <!DOCTYPE html>
<html lang="en">
...
<body>
    <div class="container-box" style="font-family: Arial, sans-serif;">
        ...
        <div class="main-content">
            ...
            <p class="footer-text">
                We've attached the agent information for your reference. Please use it to connect with the agent
